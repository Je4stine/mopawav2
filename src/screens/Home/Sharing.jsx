    ...
    <div className=" py-10 lg:px-[120px]">
        ...
        <div className=" my-10 lg:flex lg:justify-evenly"> 
            <div className=" flex flex-col items-center px-20">
                <img src="https://chargeeight.com/wp-content/uploads/2022/11/power-bank-stations.jpg" alt="" />
            ...
            <div className=" flex flex-col items-center px-20">
                <img src="https://chargeeight.com/wp-content/uploads/2022/11/Powerbank-station-Payment.jpg" alt="" />
                <h2 className=" my-5 font-bold text-xl">Payment Application Programming Interface</h2>
                <p>We’ve already integrated payment gateways in 50+ countries, including Paypal, Stripe, Google Pay, Apple Pay, etc </p>
            </div>
            <div className=" flex flex-col items-center px-20">
