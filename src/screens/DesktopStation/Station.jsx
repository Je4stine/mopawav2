  ...
  return (
    <div>
      ...
      <div className=' min-h-[20vh] flex flex-col items-center justify-center'> 
        <img src={Powerbanks} alt="stand" className=" lg:h-[35vh] object-cover my-5" />
      </div>
      <p className=' text-center my-5 text-xl'>We offer various Desktop stations from 8 slot to 12 slot and a stackable desktop station </p>
