...
function Footer() {
  ...
  const { visitorCount, setVisitorCount } = useContext(AppContext);
  ...
  return (
    <div className="z-[1] w-full ">
      <div className="lg:flex lg:flex-row lg:justify-around bg-black p-10">
        ...
        <div className="flex-1 py-5 lg:py-0">
          ...
          <div className=" flex flex-row items-center mt-5">
            <a
              href="https://www.facebook.com/mopawasoftware"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/mopawasoftwareke/"
              target="_blank"
              className="border border-white p-2"
            >
              <FaInstagramSquare color="white" size={27} />
            </a>
            <a
              href="https://x.com/MopawaLtd"
              target="_blank"
              className="border border-white p-2"
            >
              <FaXTwitter color="white" size={27} />
            </a>
            <div className=" text-white ml-10">{visitorCount.count}</div>
          </div>
        </div>
        ...
        <div className="flex-1 border-t lg:border-l lg:border-t-0 border-gray-600 lg:pl-10 py-5">
          ...
          <a href="/blog" className="text-gray-400 hover:underline">
            <strong>
              What is Power Bank Sharing and How to Start This Business?{" "}
            </strong>
            <br /> <br />
            Before looking into what “sharing power bank station” is, we need to
            figure out what is sharing economy, because sharing power bank is
            definitely a part of sharing economy. In this...
          </a>
        </div>
        ...
        <div className="flex-1 border-t lg:border-l lg:border-t-0 border-gray-600 lg:pl-10 py-5">
          ...
          <ul className="text-gray-200 space-y-2">
            ...
            <li>
              <a href="/customs">Customization</a>
            </li>
            <li>
              <a href="/faq">FAQs</a>
            </li>
      ...
      <div className=" bg-gray-950 flex items-center justify-center text-gray-400 h-[100px]">
        <p>
          Copyright © {curretYear} Mopawa - Rental Power banks! All Rights
          Reserved.
        </p>
      </div>
    </div>
