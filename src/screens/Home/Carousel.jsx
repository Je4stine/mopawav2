  ...
  return (
    <div className="h-[85vh]">
      ...
      <div className="h-full relative">
            ...
            <div className="absolute h-full w-full top-0 left-0 lg:ml-[10%] flex flex-col justify-center lg:items-start items-center">
                <div className="my-10">
                    <div className="flex flex-row">
                        <div className="w-[6px] bg-yellow-400"></div>
                        <div>
                            <p className="text-white ml-3">Shared powerbank Service Provider</p>
                        </div>
                    </div>
                </div>

                <h1 className="text-white lg:text-7xl text-4xl font-bold text-center lg:text-left">Joint<br/> Entrepreneurship</h1>
                <p className="text-white lg:text-2xl mt-10 text-center lg:text-left">
                    Join us in making charging easy<br/> join us to dive in the potential market
                </p>
    ...
    <div className="my-10">
        ...
        <h1 className="text-white lg:text-6xl text-3xl font-bold text-center lg:text-left">The leading rental<br/>powerbank service provider <br/> in East Africa</h1>
        <p className="text-white lg:text-2xl mt-10 text-center lg:text-left">An Interview with KBC</p>
...
<div className="h-full relative">
    ...
    <div className="my-10">
        ...
        <h1 className="text-white lg:text-6xl text-3xl font-bold text-center lg:text-left">Seize The<br/> Viewable<br/> future<br/></h1>
        <p className="text-white lg:text-2xl mt-10 text-center lg:text-left">
            Powerbank sharing is the future of outdoor charging solution,<br/> join us to dive in the potential market
        </p>
