import Eight from '../../assets/images/stackable.png'
    ...
    <div>
      ...
      <div className=" min-h-[20vh]">
          <div className=' lg:flex items-center justify-center p-4'>
              ...
              <h1 className=' font-bold text-3xl mb-5'>Stackable Desktop Station</h1>
              <p>
              Applicable to: catering, bar, KTV, hotel, guide desk and other small and medium-sized scenes.

                You can choose one layer(8 slots of power banks) or two layers (16 slots of power bank) flexible depending on the customer traffic.
